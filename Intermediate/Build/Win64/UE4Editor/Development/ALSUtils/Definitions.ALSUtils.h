...
#define UE_PROJECT_NAME GenestealerProject
#define UE_TARGET_NAME GenestealerProjectEditor
#define UE_MODULE_NAME "ALSUtils"
#define UE_PLUGIN_NAME "ALSUtils"
